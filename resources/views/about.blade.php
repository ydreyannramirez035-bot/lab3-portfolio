...
@section('content')
    ...
    <div class="card p-4 shadow-sm mt-2 mb-5">
        ...
        <ul class="list-group mt-3 mb-4">
            ...
            <li class="list-group-item"><small>I like pastel colors and sometimes darker shades as well.</small></li>
            <li class="list-group-item"><small>My favorite color is blue.</small></li>
            <li class="list-group-item"><small>I don’t usually like cats or dogs, but I find some of them cute.</small></li>
        </ul>
    </div>
@endsection